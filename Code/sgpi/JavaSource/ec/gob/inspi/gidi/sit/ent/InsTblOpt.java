...
/**
 * The persistent class for the ins_tbl_opt database table.
 * 
 */
@Entity
@Table(name="ins_tbl_opt")
@NamedQuery(name="InsTblOpt.findAll", query="SELECT i FROM InsTblOpt i")
public class InsTblOpt implements Serializable {
