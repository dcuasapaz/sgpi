...
COMMENT ON COLUMN sit_tbl_opt.i_opt_fth IS 'FK --> C�digo padre'; 
COMMENT ON COLUMN sit_tbl_opt.s_opt_nme IS 'Nombre opci�n'; 
COMMENT ON COLUMN sit_tbl_opt.s_opt_acr IS 'Acronimo opci�n'; 
COMMENT ON COLUMN sit_tbl_opt.s_opt_dsc IS 'Descripci�n opci�n'; 
